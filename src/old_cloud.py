...
class CloudProxy:
    ...
    def get_pointcloud_from_depth(self, cam_id, instruction, visualize=False):
        depth = self.get_depth_image(cam_id)
        rgb = self.get_rgb_image(cam_id)
    ...
    def getObs(self, instruction, block_clip_processor=False, task_name=None):
        ...
        depth = np.rot90(self.get_depth_image(2)[190:480, 515:725], 2)
        rgb = np.rot90(self.get_rgb_image(2)[190:480, 515:725], 2)
