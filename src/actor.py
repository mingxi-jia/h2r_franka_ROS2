...
from agents import OpenVLAAgent
...
from config.configs import JOINT_HOME
...
class Actor():
    ...
    def act(self, rgb, depth, current_pose, franka_joint):
        ...
        print(action_rel)
        goal_pose_quat = R.from_matrix(current_pose_R).as_quat()
        goal_pose_quat = np.array([1.,0.,0.,0.])
