    ...
    def calcTDLoss(self):
        ...
        if self.sl:
            ...
            with torch.no_grad():
                ...
                q1 = q1_map_prime[torch.arange(0, batch_size), x_star[:, 0], x_star[:, 1]]
        ...
        td_loss = F.smooth_l1_loss(q1_pred * q2_pred, q_target)

        with torch.no_grad():
            td_error = torch.abs(q1_pred * q2_pred - q_target)
